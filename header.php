...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en" itemscope itemtype="http://schema.org/Product" <?php language_attributes(); ?>> <!--<![endif]-->
<head>
	...
	<?php 
	$bgcolor = cwp('bg_color');
	$customcss = cwp('custom_css');
  	...
  	<div class="row preheader">
  	  <div class="sixteen columns special head" id="header">
	  	<div class="seven columns logo">
			<?php				
				$logo_image = cwp('logo_image');				
				$logo_text = cwp('logo_text');				
				if (isset($logo_image) && $logo_image != ''){ 			
			?>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo $logo_image ?>" border="0" /></a>
			<?php 				
				} 				
		...
		<div class="sixteen columns nav">
			<nav>
                <?php if ( has_nav_menu( 'main-menu' ) ) {
					...
					<ul class="menu">
						<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php _e('Home','cwp'); ?></a></li>
